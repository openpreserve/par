...
import org.parcore.api.client.auth.ApiKeyAuth;
import org.parcore.api.client.auth.Authentication;
import org.parcore.api.client.auth.HttpBasicAuth;
import org.parcore.api.client.auth.OAuth;
 ...
 * ApiClient
 * <p>
 * Generic client for the PAR API. This controls the endpoint details, SSL certificate details etc as well as the
 * actual execution of HTTP requests and serialization/de-serialization of the JSON types.
 * <p>
...
public class ApiClient {
    ...
    private String basePath = "https://parcore.org/par";
    ...
    public ApiClient() {
        ...
        setUserAgent("PAR SDK Client/1.0.0/java");

        // Setup authentications (key: authentication name, value: authentication).
        authentications = new HashMap<>();
        authentications.put("authorization", new HttpBasicAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://preservica.com/Registry/par
    ...
    public Pair parameterToSinglePair(String name, Object value) {
        return parameterToPair(name, value).get(0);
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    private Request buildRequest(String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams, Object body, Map<String, String> headerParams, Map<String, Object> formParams, String[] authNames, ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private KeyStore newEmptyKeyStore() throws GeneralSecurityException {
        try {
            ...
            keyStore.load(null, null);  //Any password will work
            return keyStore;
        } catch (IOException e) {
